...
class GoalViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Generate image for the goal
        image_service = PerplexityImageService()
        goal.image_url = image_service.generate_goal_image(goal.title)
        goal.save()
    ...
    def generate_image(self, request, pk=None):
        """Generate placeholder image for a goal"""
        goal = self.get_object()
        
        # Generate new image for the goal
        image_service = PerplexityImageService()
        new_image_url = image_service.generate_goal_image(goal.title)
